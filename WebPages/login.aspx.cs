...
public partial class WebPages_login : System.Web.UI.Page
{
    ...
    protected void ButtonLogin_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "select * from Tbl_Login where Login_username='"+Username+"' and Login_password='"+Password+"' and Login_ActiveFlag=1";
            int res = 0;
            objsql.Open();
            ...
            if (res > 0)
            {
                ShowMessageAndRedirect("Login Successfull", "memberinfo.aspx");
            }
            else
            {
